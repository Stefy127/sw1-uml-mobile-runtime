...
class _DynamicDetailPageState extends State<DynamicDetailPage> {
  ...
  late final RelationResolver _resolver = RelationResolver(_api, widget.schema);
  ...
  Future<void> _delete() async {
    ...
    try { await _api.delete(widget.entity.endpoint, widget.record[widget.entity.idField]); if (mounted) Navigator.pop(context, true); } catch (e) { if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('No se pudo eliminar. Puede tener registros relacionados.'))); }
  }
